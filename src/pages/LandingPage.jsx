...
function LandingPage() {
    return (
        <div>
            ...
            <section style={{ height: '700px', backgroundImage: "url('https://th.bing.com/th/id/OIP.NqXojvDWYNrNIVgxb5CfLgAAAA?w=195&h=180&c=7&r=0&o=7&dpr=1.3&pid=1.7&rm=3')", backgroundSize: 'cover', backgroundAttachment: 'fixed' }} className='d-flex align-items-center justify-content-center'>
            ...
            <section style={{ height: '450px', backgroundImage: "url('https://th.bing.com/th/id/OIP.3Qyqa51rd9phsF_n0Pd2vwHaEo?w=298&h=186&c=7&r=0&o=7&dpr=1.3&pid=1.7&rm=3')", backgroundSize: 'cover', backgroundPosition: 'center', backgroundAttachment: 'fixed' }}>
            </section>
